...
import { useEventsController } from '../../../services/useEventsController';
import UserMarker from '../components/markers/UserMarker';
import ClusterMarker, {clusterMarkerDiameter} from '../components/markers/ClusterMarker';
...
import { findFarthestEvent } from '../functions/findFarthestEvent';
import { getCenterCoordinate } from '../functions/getCenterCoordinate';
import useStore, {useLocationState} from '../../common/store/store';
